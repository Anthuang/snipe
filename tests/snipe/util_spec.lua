...
describe("util:", function()
  ...
  describe("merge_ts_ranges", function()
  ...
  describe("trim_string", function()
    it("trims starting whitespaces", function()
      assert.are.equal(util.trim_string("test"), "test")
      assert.are.equal(util.trim_string("   test"), "test")
      assert.are.equal(util.trim_string("   test test"), "test test")
    end)

    it("trims trailing whitespaces", function()
      assert.are.equal(util.trim_string("test"), "test")
      assert.are.equal(util.trim_string("test    "), "test")
      assert.are.equal(util.trim_string("test test    "), "test test")
    end)

    it("trims whitespaces from both ends", function()
      assert.are.equal(util.trim_string("test"), "test")
      assert.are.equal(util.trim_string("   test    "), "test")
      assert.are.equal(util.trim_string("   test test    "), "test test")
    end)
